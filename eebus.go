...
func NewEebusNode(isGateway bool, certName string) *EebusNode {
	deviceModel := &ressources.DeviceModel{}
	newEebusNode := &EebusNode{isGateway, nil, deviceModel, nil}
	newEebusNode.SpineNode = spine.NewSpineNode(isGateway, deviceModel, newEebusNode.SubscriptionNofity, certName)
	return newEebusNode
}
